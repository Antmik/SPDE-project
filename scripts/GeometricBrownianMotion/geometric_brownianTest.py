...
#    plt.savefig('rho.png')
    ...
    plt.plot(dt_vec,0.01*dt_vec**2,lw=.5,ls=line_style[1],marker=marker_style[0],ms=0,mew=.1,mfc='none', color=color_vec[8], label=r"order 2")
...
#########################################################################################
    ...
    plt.plot(dt_vec,0.1*dt_vec**(1/2),lw=.5,ls=line_style[1],marker=marker_style[0],ms=0,mew=.1,mfc='none', color=color_vec[7], label=r"order 0.5")
    plt.plot(dt_vec,0.1*dt_vec,lw=.5,ls=line_style[1],marker=marker_style[0],ms=0,mew=.1,mfc='none', color=color_vec[8], label=r"order 1")
